...
import { ChevronDown, Phone, MapPin, Clock, Star, CheckCircle, Wrench, AlertTriangle } from "lucide-react";
  ...
  const garageIssues = [
    {
      ...
      problem: "Motor runs but door won't budge? Complete silence when you hit the remote?",
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-black to-gray-900 text-white py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            ...
            Speak with a Garage Door Expert Now
          </Button>
        </div>
      </section>
              ...
              <Card key={index} className="border-2 hover:border-yellow-400 transition-colors">
                <CardContent className="p-0">
                  ...
                  >
                    ...
                    <ChevronDown 
                      className={`h-6 w-6 text-yellow-500 transition-transform ${
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              <span className="text-yellow-400">✓</span> Serving These Major Cities & States
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {metroAreas.map((area, index) => (
              <div key={index} className="bg-gray-900 p-4 rounded-lg border border-yellow-400">
                <div className="flex items-center space-x-3">
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-black to-gray-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button 
            size="lg"
            className="bg-yellow-400 text-black hover:bg-yellow-300 font-bold px-12 py-6 text-2xl"
            onClick={() => window.open(`tel:${phoneNumber}`, '_self')}
          >
