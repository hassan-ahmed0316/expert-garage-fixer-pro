...
const Index = () => {
  ...
  // Testimonials data as a hook
  const testimonials = [
    {
      name: "John Smith",
      initials: "JS",
      location: "Miami, FL",
      text: "Incredible service! My garage door was stuck and they had it fixed in under an hour. The technician was professional and explained everything clearly. Highly recommend!"
    },
    {
      name: "Maria Lopez",
      initials: "ML",
      location: "Chicago, IL",
      text: "Emergency service at 2 AM! My garage door wouldn't close and they were here within 30 minutes. Fixed the issue and even cleaned up after themselves. Outstanding!"
    },
    {
      name: "Robert Taylor",
      initials: "RT",
      location: "Dallas, TX",
      text: "Bob Handyman replaced my old garage door opener with a new smart system. The installation was clean and professional. Now I can control my garage from my phone!"
    },
    {
      name: "Emily Chen",
      initials: "EC",
      location: "Boston, MA",
      text: "Very friendly and honest. Bob explained all my options and didn't try to upsell me. My door works perfectly now."
    },
    {
      name: "David Patel",
      initials: "DP",
      location: "Phoenix, AZ",
      text: "Quick, efficient, and affordable. I called in the morning and my garage door was fixed before lunch. Will use again."
    },
    {
      name: "Sarah Johnson",
      initials: "SJ",
      location: "Seattle, WA",
      text: "Bob Handyman is the real deal. He fixed a problem two other companies couldn't. Super grateful!"
    }
  ];
            ...
            >
              <CarouselContent className="ml-0">
                {testimonials.map((t, idx) => (
                  <CarouselItem
                    key={idx}
                    className={`sm:basis-1/2 lg:basis-1/3 px-2${idx === 0 ? ' pl-0' : ''}`}
                  >
                    <Card className="border-2 border-gray-200 hover:border-yellow-400 transition-all duration-300 shadow-sm hover:shadow-md h-full flex flex-col justify-between">
              ...
              <CarouselPrevious className="-translate-y-1/2 absolute -left-2 sm:-left-4 lg:-left-8 top-1/2 bg-white/80 hover:bg-yellow-400 text-black shadow-md rounded-full border border-gray-200 transition-colors z-10 h-6 w-6 sm:h-8 sm:w-8" />
              <CarouselNext className="-translate-y-1/2 absolute -right-2 sm:-right-4 lg:-right-8 top-1/2 bg-white/80 hover:bg-yellow-400 text-black shadow-md rounded-full border border-gray-200 transition-colors z-10 h-6 w-6 sm:h-8 sm:w-8" />
            </Carousel>
          </div>
